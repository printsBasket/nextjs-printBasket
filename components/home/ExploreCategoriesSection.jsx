...
import { ArrowRight, Home, Briefcase, Printer, Zap } from 'lucide-react';
...
const ExploreCategoriesSection = () => {
  ...
  const handleCategoryClick = (filter, filterType) => {
    ...
    if (filterType === 'usage') {
      if (filter === "Home") router.push("/shop/home/");
      else if (filter === "Office") router.push("/shop/office/");
      else router.push(`/shop/?usageCategory=${filter}`);
    } else if (filterType === 'technology') {
      if (filter === "Inkjet") router.push("/shop/inkjet/");
      else if (filter === "Laser") router.push("/shop/laser/");
      else router.push(`/shop/?technology=${filter}`);
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <button
            ...
            className="group relative bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 p-4 sm:p-5 lg:p-6 text-left border border-blue-200 hover:border-blue-400 cursor-pointer"
          >
            ...
            <div className="relative z-10">
              <div className="mb-4">{categories[0].icon}</div>
          ...
          <button
            ...
            className="group relative bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 p-4 sm:p-5 lg:p-6 text-left border border-purple-200 hover:border-purple-400 cursor-pointer"
          >
            ...
            <div className="relative z-10">
              <div className="mb-4">{categories[1].icon}</div>
          ...
          <button
            ...
            className="group relative bg-gradient-to-br from-rose-50 to-rose-100 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 p-4 sm:p-5 lg:p-6 text-left border border-rose-200 hover:border-rose-400 cursor-pointer"
          >
            ...
            <div className="relative z-10">
              <div className="mb-4">{categories[2].icon}</div>
          ...
          <button
            ...
            className="group relative bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 p-4 sm:p-5 lg:p-6 text-left border border-amber-200 hover:border-amber-400 cursor-pointer"
          >
            ...
            <div className="relative z-10">
              <div className="mb-4">{categories[3].icon}</div>
