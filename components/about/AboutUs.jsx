    ...
    <div className="w-full bg-white">
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/shop/" className="inline-block bg-white text-blue-600 font-semibold px-6 sm:px-8 py-3 rounded-lg hover:bg-gray-100 transition-colors text-sm sm:text-base">
            Shop Now
          </Link>
        </div>
      </section>
