    ...
    <footer className="bg-gradient-to-br from-black via-[#0b0b0b] to-[#3b1f00] text-white pt-8 sm:pt-10 lg:pt-12 pb-6 sm:pb-8 w-full">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300 text-sm sm:text-base">
            ...
            <li><Link href="/terms-and-conditions/" className="hover:text-blue-400 transition">Terms & Conditions</Link></li>
            <li><Link href="/return-exchange-policy/" className="hover:text-blue-400 transition">Return & Exchange</Link></li>
            <li><Link href="/shipping-policy/" className="hover:text-blue-400 transition">Shipping Policy</Link></li>
            <li><Link href="/cookie-policy/" className="hover:text-blue-400 transition">Cookie Policy</Link></li>
            <li><Link href="/refund-return-policy/" className="hover:text-blue-400 transition">Refund Policy</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300 text-sm sm:text-base">
            ...
            <li><Link href="/blogs/" className="hover:text-blue-400 transition">Blogs</Link></li>
            ...
            <li><Link href="/contact-us/" className="hover:text-blue-400 transition">Support</Link></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 mt-8 pt-6 border-t border-gray-700 flex flex-col sm:flex-row justify-between items-center text-gray-400 text-sm sm:text-base gap-4">
        ...
        <div className="flex gap-4 flex-wrap justify-center sm:justify-end">
          <Link href="/do-not-sell/" className="hover:text-blue-400 transition">
            Do Not Sell
          </Link>
          <span className="text-gray-600">|</span>
          <Link href="/eula/" className="hover:text-blue-400 transition">
            EULA
          </Link>
          <span className="text-gray-600">|</span>
