...
const Categories = () => {
  ...
  const handleCategoryClick = (filterType, filterValue) => {
    if (filterType === "usage") {
      if (filterValue === "Home") router.push("/shop/home/");
      else if (filterValue === "Office") router.push("/shop/office/");
      else router.push(`/shop/?usageCategory=${filterValue}`);
    } else if (filterType === "technology") {
      if (filterValue === "Inkjet") router.push("/shop/inkjet/");
      else if (filterValue === "Laser") router.push("/shop/laser/");
      else router.push(`/shop/?technology=${filterValue}`);
    }
  };
