                        ...
                        <form className="space-y-4" onSubmit={submitHandler}>
                            <div>
                                <input
                                    type="email"
                                    placeholder="Email"
                                    className="w-full border-b py-2 outline-none focus:border-blue-500 transition-colors text-slate-800"
                                    value={email}
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full border-b py-2 outline-none focus:border-blue-500 transition-colors pr-10 text-slate-800"
                                    value={password}
                            ...
                            <div className="flex justify-between text-sm">
                                <button
                                    ...
                                    className="text-blue-500 cursor-pointer hover:text-blue-600 font-medium bg-transparent border-none p-0"
                                >
                                    Forgot password?
                                </button>
                            </div>
                        ...
                        <form className="space-y-4" onSubmit={submitHandler}>
                            <div className="grid grid-cols-1 min-[360px]:grid-cols-2 gap-3">
                                <input
                                    ...
                                    className="border-b py-2 outline-none focus:border-blue-500 transition-colors text-slate-800"
                                    value={firstName}
                        ...
                        <form className="space-y-4" onSubmit={submitHandler}>
                            ...
                            <div>
                                <input
                                    type="text"
                                    placeholder="000000"
                                    className="w-full border-b py-2 outline-none focus:border-blue-500 transition-colors text-center text-lg font-mono text-slate-800"
                                    value={otp}
