...
const AdminProducts = () => {
    ...
    const handleEdit = (product) => {
        ...
        const cleanedShortSpec = stripHtml(product.shortSpecification || '');
        ...
        setFormData({
            ...
            shortSpecification: cleanedShortSpec,
    ...
    const handleSubmit = (e) => {
        ...
        Object.keys(formData).forEach(key => {
            if (key === 'images') {
                ...
                data.append('technicalSpecification', specType === 'table' ? finalTechSpecs : formData.technicalSpecification);
            } else if (key === 'description') {
                data.append(key, stripHtml(formData[key]));
            } else if (key === 'shortSpecification') {
                data.append(key, stripHtml(formData[key]));
            } else {
    ...
    const textareaClass = "w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none font-medium text-slate-800 min-h-[150px] resize-y";
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                                <div className="space-y-2">
                                    ...
                                    <div
                                        ...
                                        className={`${textareaClass} overflow-auto min-h-[180px] prose prose-slate text-sm leading-relaxed`}
                                        dangerouslySetInnerHTML={{ __html: formData.shortDetails || '<p><br></p>' }}
                                        onInput={(e) => handleQuillChange('shortDetails', e.currentTarget.innerHTML)}
                                    />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <div
                                        ...
                                        suppressContentEditableWarning
                                        className={`${textareaClass} overflow-auto min-h-[180px] prose prose-slate text-sm leading-relaxed`}
                                        dangerouslySetInnerHTML={{ __html: formData.overview || '<p><br></p>' }}
                                        onInput={(e) => handleQuillChange('overview', e.currentTarget.innerHTML)}
                                    />
                                </div>
                            </div>
                        </div>
