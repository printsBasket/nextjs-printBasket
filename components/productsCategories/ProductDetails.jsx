                        ...
                        {activeTab === "overview" && (
                            <div className="max-w-4xl animate-fadeIn">
                                {product.description && /<[^>]+>/.test(product.description) ? (
                                    <div className="text-slate-600 font-medium leading-relaxed text-base md:text-lg mb-8 prose prose-slate" dangerouslySetInnerHTML={{ __html: product.description }} />
                                ) : (
                                    <p className="text-slate-600 font-medium leading-relaxed text-base md:text-lg mb-8 whitespace-pre-wrap">
                                        {product.description}
                                    </p>
                                )}
                                {product.overview && (
