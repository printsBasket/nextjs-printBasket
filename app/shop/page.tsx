...
export const metadata: Metadata = {
  ...
  description: 'Browse our full selection of inkjet printers, laser printers, all-in-one printers, and printing supplies. Shop Prints Basket for the best prices with free shipping across North America.',
